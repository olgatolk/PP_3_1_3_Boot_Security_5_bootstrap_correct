...
INSERT INTO `users` (`first_name`, `last_name`, `age`, `email`, `password`) VALUES ('Patrick', 'Pat', 12,'patrick@mail.com',
                                                 '$2a$12$XW7j6pv8gpk4ea9Wo/cWPusTYpgI03blcLh60Dv5xCm/nBx0q5RTS');
INSERT INTO `users` (`first_name`, `last_name`, `age`, `email`, `password`) VALUES ('Sim', 'Tol', 22,'sim@mail.com',
                                                  '$2a$12$gMllPjRVcLHz4eMFX6J1we9RqOnL002QF8h6mpwOVyx7EoNYbYD6O');
INSERT INTO `users` (`first_name`, `last_name`, `age`, `email`, `password`) VALUES ('Dym', 'Chick', 18,'dym@mail.com',
